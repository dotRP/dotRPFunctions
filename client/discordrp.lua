Citizen.CreateThread(function()
	while true do
		...
		SetDiscordAppId(1010521228076920853)

        -- Here you will have to put the image name for the "large" icon.
		SetDiscordRichPresenceAsset('dotrp_logo_2')
        
        -- (11-11-2018) New Natives:

        -- Here you can add hover text for the "large" icon.
        SetDiscordRichPresenceAssetText('dotRP')
       
        -- Here you will have to put the image name for the "small" icon.
        SetDiscordRichPresenceAssetSmall('dotrp_logo_2')

        -- Here you can add hover text for the "small" icon.
        SetDiscordRichPresenceAssetSmallText('dotRP')
        ...
        SetDiscordRichPresenceAction(0, "Join The Discord", "https://discord.dotroleplay.com")
		SetDiscordRichPresenceAction(1, "CAD", "https://cad.dotroleplay.com/")
