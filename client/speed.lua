	...
	while Config.LimiterON do
        ...
        then
            if math.floor(currentcarspeed*Config.Speedo_Math) == Config.Class_Compacts_Maxspeed then
				...
				if Config.Debug then
					print('Car Class is '..class.." Max Speed it "..Config.Class_Compacts_Maxspeed.." Setspeed is "..setspeed)
				end
        ...
        then
            if math.floor(currentcarspeed*Config.Speedo_Math) == Config.Class_Sedan_Maxspeed then
				...
				SetVehicleMaxSpeed(GetVehiclePedIsIn(PlayerPedId(), false), setspeed)
				if Config.Debug then
					print('Car Class is '..class.." Max Speed it "..Config.Class_Sedan_Maxspeed.." Setspeed is "..setspeed)
				end
			end
        ...
        then
            if math.floor(currentcarspeed*Config.Speedo_Math) == Config.Class_SUV_Maxspeed then
				...
				SetVehicleMaxSpeed(GetVehiclePedIsIn(PlayerPedId(), false), setspeed)
				if Config.Debug then
					print('Car Class is '..class.." Max Speed it "..Config.Class_SUV_Maxspeed.." Setspeed is "..setspeed)
				end
			end
        ...
        then
            if math.floor(currentcarspeed*Config.Speedo_Math) == Config.Class_Motorcycle_Maxspeed then
				...
				SetVehicleMaxSpeed(GetVehiclePedIsIn(PlayerPedId(), false), setspeed)
				if Config.Debug then
					print('Car Class is '..class.." Max Speed it "..Config.Class_Motorcycle_Maxspeed.." Setspeed is "..setspeed)
				end
			end
